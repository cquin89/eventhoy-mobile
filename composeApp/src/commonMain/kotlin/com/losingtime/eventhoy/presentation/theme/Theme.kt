...
val LocalAppTypo = staticCompositionLocalOf { eventhoyTypo() }
...
fun EventhoyTheme(
    ...
    val typo = eventhoyTypo(poppinsFamily = poppinsFamily(), jakartaFamily = jakartaFamily())
    ...
    CompositionLocalProvider(LocalAppColors provides colors, LocalAppTypo provides typo,LocalAppDimensions provides dimensions) {
        MaterialTheme(
            colorScheme = materialColors, typography = Typography, content = content
        )
    }
}
