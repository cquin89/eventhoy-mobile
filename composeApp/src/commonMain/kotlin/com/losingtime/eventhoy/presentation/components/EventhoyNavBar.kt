...
sealed class NavItem(
    ...
    object Favorite :
        NavItem(EventhoyScreen.Favorite, "Favoritos", Res.drawable.bookmark, Res.drawable.bookmark)

    object Profile : NavItem(
        EventhoyScreen.Profile,
        "Editar Perfil",
        Res.drawable.user_rectangle,
        Res.drawable.user_rectangle
    )
}
...
fun BottomNavigationBarDarkThemePreview(navController: NavHostController = rememberNavController()) {
    EventhoyTheme(darkTheme = true) {
        EventhoyNavBar(
            ...
            items = listOf(NavItem.Home, NavItem.Favorite, NavItem.Profile)
        )
    }
